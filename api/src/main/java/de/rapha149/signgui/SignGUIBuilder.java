...
import static de.rapha149.signgui.SignGUI.WRAPPER;

/**
 * Builder for {@link de.rapha149.signgui.SignGUI}.
 */
public class SignGUIBuilder {
    ...
    /**
     * Constructs a new SignGUIBuilder. Use {@link de.rapha149.signgui.SignGUI#builder()} to get a new instance.
     */
    SignGUIBuilder() {
    }
    ...
    public SignGUIBuilder setType(Material type) {
        ...
        Validate.isTrue(WRAPPER.getSignTypes().contains(type), type + " is not a sign type. Available sign types: " + SignGUI.availableSignTypes);
        this.type = type;
        return this;
    }
